...
// tileScene und optionales Overlay (Flagge / Haus)
const tileScene = computed<Object3D | null>(() => state.value?.scene ?? null)
...
<template>
  ...
  <primitive v-if="tileScene" :object="tileScene" @pointerdown="handleClick" />

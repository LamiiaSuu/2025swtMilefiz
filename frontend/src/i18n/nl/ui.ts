...
export const UI_NL: Record<UIKey, string> = {
    ...
    ROLL_DICE_TUTORIAL_1: 'Elke 5 seconden kun je een zeszijdige dobbelsteen gooien.',
    ROLL_DICE_TUTORIAL_2: 'Je kunt kiezen om te bewegen, te springen of energie op te slaan.',
    ROLL_DICE_TUTORIAL_3: 'Direct na elke worp start de cooldown van 5 seconden opnieuw.',

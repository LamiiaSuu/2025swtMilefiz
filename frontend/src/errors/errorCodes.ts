...
export type ErrorCode =
  ...
  | 'REJECTED_BY_BARRIER'
  | 'SAVE_ENERGY_ERROR_MAX_ENERGY'
  | 'SAVE_ENERGY_ERROR_MEEPLE_MOVED'
  | 'SAVE_ENERGY_ERROR_DICE_NOT_ROLLED'
  ...
  | 'MINIGAME_SELECTION_MODE_RANDOM'
  | 'MINIGAME_SELECTION_MODE_INORDER'

 ...
 *
 * Dieses Ereignis informiert das Frontend darüber, dass der Spieler versucht
 * hat,
 ...
 * @param remainingMoves Anzahl der verbleibenden Züge nach der Kollision (in
 *                       der Regel 0)
 *
 * @author Maximilian Ressel
 */
public record FrontendRejectedByBarrierEvent(String type, UUID playerId, int remainingMoves, String msg)

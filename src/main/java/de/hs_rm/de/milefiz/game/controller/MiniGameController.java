...
public class MiniGameController {
        ...
        /**
         * Verarbeitet eine Client-Anfrage zum (erneuten) Senden des aktuellen Zielworts
         * für das MonkeyType-Minigame.
         * <p>
         * Dieser Endpunkt dient primär zur Resynchronisation, z. B. wenn ein Client
         * später beitritt, sich neu verbindet oder das initiale {@code targetWord}
         * noch nicht per Broadcast erhalten hat.
         * <p>
         * Falls das {@link MonkeyTypeGame} noch nicht initialisiert ist
         * (Spieler/Zielwort noch nicht gesetzt), wird das Spiel einmalig initialisiert
         * und anschließend ein Status-Update an alle Clients der Lobby gesendet.
         *
         * @param lobbyId ID der Lobby
         * @param duelId  ID des Duells
